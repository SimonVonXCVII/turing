package com.simonvonxcvii.turing.common.config
...
@EnableJpaAuditing
// 清晰化 jpa 包路径
@EnableJpaRepositories("com.simonvonxcvii.turing.common.repository.jpa")
@EntityScan("com.simonvonxcvii.turing.common.entity")
class JpaConfig {
    /**
     * 定义审核员信息
     *
