...
import com.simonvonxcvii.turing.common.model.query.PageQuery
...
/**
 * DTO for [com.simonvonxcvii.turing.resource.server.entity.Menu]
 *
 * @author Simon Von
...
data class MenuDto(
     ...
     * 菜单类型：目录、菜单、按钮、内嵌、外链
     *
     * @see com.simonvonxcvii.turing.resource.server.enums.MenuTypeEnum
     */
