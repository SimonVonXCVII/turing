...
@OpenAPIDefinition(
    ...
    info = Info(
        ...
        contact = Contact(
            name = "Simon Von",
            url = "github.com/simonvonxcvii",
            email = "g1672943850@gmail.com",
    ...
    servers = [
        ...
        Server(url = "http://localhost:8080", description = "测试环境地址"),
        Server(url = "http://localhost:8080", description = "生产环境地址")
    ],
    ...
    security = [
        ...
        SecurityRequirement(
            ...
            // 如果安全方案类型为“oauth2”或“openIdConnect”，则该值是执行所需的作用域名称列表。对于其他安全方案类型，该数组必须为空。
//            scopes = []
        )
    ],
    // API 的任何其他外部文档
